...
function PlayerPropsPanel({
  ...
  return (
    <>
      ...
      {!loading && sport === "nba" && nba.length === 0 && !error && (
        <div style={{ color: C.textMuted, padding: 32, textAlign: "center" }}>No NBA players found.</div>
      )}
      {!loading && sport === "mlb" && mlb.length === 0 && !error && (

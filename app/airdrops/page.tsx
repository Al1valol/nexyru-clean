  ...
  const airdrops: Airdrop[] = [
    {
      ...
      tasks: [
        {id:'sonic1', label:'Create account on Sonic', description:'Sign up at sonic.game', cost:'Free', difficulty:'easy', completed:false, link:'https://sonic.game'},
        {id:'sonic2', label:'Play games daily', description:'Play any game for 15+ mins per day to earn points', cost:'Free', difficulty:'easy', completed:false, link:'https://sonic.game'},
        {id:'sonic3', label:'Complete daily check-in', description:'Check in every day for streak bonus', cost:'Free', difficulty:'easy', completed:false, link:'https://sonic.game'},
        {id:'sonic4', label:'Join Discord and verify', description:'Join Sonic Discord and verify your wallet', cost:'Free', difficulty:'easy', completed:false, link:'https://discord.gg/sonicsvmlabs'},
      ],
      links: [{label:'App', url:'https://sonic.game'},{label:'Discord', url:'https://discord.gg/sonicsvmlabs'},{label:'Twitter', url:'https://twitter.com/SonicSVM'}],
    },
    {
      id: 'kamino',
      name: 'Kamino Finance',
    ...
    },
    {
      ...
      tasks: [
        ...
        {id:'lz4', label:'Check points on LayerZero Scan', description:'Track your LayerZero points at layerzeroscan.com', cost:'Free', difficulty:'easy', completed:false, link:'https://layerzeroscan.com'},
      ],
    ...
    },
    {
      ...
      tasks: [
        {id:'zk1', label:'Bridge to zkSync', description:'Bridge $20-50 ETH to zkSync Era via official bridge', cost:'$5-15 gas', difficulty:'easy', completed:false, link:'https://portal.zksync.io/bridge'},
        ...
        {id:'zk3', label:'Use zkSync weekly', description:'Make at least 1 transaction per week', cost:'Gas each time', difficulty:'easy', completed:false, link:'https://portal.zksync.io/bridge'},
      ],
      links: [{label:'Bridge', url:'https://portal.zksync.io/bridge'},{label:'Twitter', url:'https://twitter.com/zksync'}],
    },
    {
      id: 'base-protocols',
      name: 'Base Ecosystem',
      ...
      tasks: [
        {id:'base1', label:'Bridge to Base', description:'Bridge $20-50 from Ethereum or use Coinbase to Base', cost:'$1-5 gas', difficulty:'easy', completed:false, link:'https://bridge.base.org/deposit'},
        ...
        {id:'base3', label:'Supply on Morpho', description:'Supply USDC or ETH on Morpho lending protocol', cost:'$20 minimum recommended', difficulty:'easy', completed:false, link:'https://app.morpho.org'},
        {id:'base4', label:'Use Base weekly', description:'At least 1 transaction per week on Base', cost:'Almost free gas', difficulty:'easy', completed:false, link:'https://bridge.base.org/deposit'},
      ],
    ...
    },
    {
      ...
      tasks: [
        {id:'monad1', label:'Join Monad Discord', description:'Join and get the community role', cost:'Free', difficulty:'easy', completed:false, link:'https://discord.gg/monadlabs'},
    ...
    },
    {
      ...
      tasks: [
        {id:'jup1', label:'Use Jupiter to swap', description:'Swap any tokens on jup.ag — most volume DEX on Solana', cost:'Gas ~$0.001', difficulty:'easy', completed:false, link:'https://jup.ag'},
        {id:'jup2', label:'Provide liquidity', description:'Add liquidity to any pool on Jupiter', cost:'$20+ recommended', difficulty:'medium', completed:false, link:'https://jup.ag/perps'},
        {id:'jup3', label:'Vote on governance', description:'Vote on JUP DAO proposals to earn bonus rewards', cost:'Free', difficulty:'easy', completed:false, link:'https://vote.jup.ag'},
        {id:'jup4', label:'Trade weekly', description:'Keep trading on Jupiter to stay active', cost:'Gas only', difficulty:'easy', completed:false, link:'https://jup.ag'},
      ],
      links: [{label:'App', url:'https://jup.ag'},{label:'Twitter', url:'https://twitter.com/JupiterExchange'}],
    },
    {
      id: 'tensor',
      ...
      chainColor: '#9945ff',
      category: 'NFTs',
      description: 'Largest NFT marketplace on Solana. Has TNSR token but ongoing trading rewards for active users.',
      estimatedValue: '$50-300',
      probability: 'MEDIUM',
      vcBacking: ['Placeholder', 'Foundation Capital'],
      totalRaised: '$3M',
      confirmed: false,
      status: 'active',
      tips: 'Buy and sell NFTs on Tensor regularly to earn trading rewards.',
      tasks: [
        {id:'tensor1', label:'Create Tensor account', description:'Visit tensor.trade and connect your Solana wallet', cost:'Free', difficulty:'easy', completed:false, link:'https://tensor.trade'},
        {id:'tensor2', label:'List an NFT for sale', description:'List any NFT you own for sale on Tensor', cost:'Free', difficulty:'easy', completed:false, link:'https://tensor.trade'},
        {id:'tensor3', label:'Make a trade', description:'Buy or sell any NFT on Tensor marketplace', cost:'NFT price + gas', difficulty:'medium', completed:false, link:'https://tensor.trade'},
        {id:'tensor4', label:'Check rewards', description:'View your trading rewards on Tensor dashboard', cost:'Free', difficulty:'easy', completed:false, link:'https://tensor.trade/rewards'},
      ],
      links: [{label:'App', url:'https://tensor.trade'},{label:'Twitter', url:'https://twitter.com/TensorHQ'}],
    },
  ]
